...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      {/* Drawer */}
      <div
        className={`fixed top-0 left-0 h-full w-[240px] bg-zinc-950 border-r border-zinc-800 z-50 flex flex-col transition-transform duration-300 ${
      ...
      >
        ...
        <div className="border-t border-zinc-800 px-4 py-3 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-zinc-500 text-xs">{profile?.role || "Admin"}</p>
          </div>
        </div>
      </div>
    </>
