...
const AddEmployeeModal = ({ onClose, onSuccess, currentUserRole }) => {
      ...
      <div className='bg-zinc-900 border border-zinc-800 rounded-2xl p-6 w-full max-w-md'>
        ...
        <div className='flex justify-between items-center mb-5 pb-4 border-b border-zinc-800'>
          <div>
            ...
            <p className='text-zinc-500 text-xs mt-0.5'>Create new account</p>
          </div>
        ...
        <form onSubmit={handleSubmit} className='flex flex-col gap-3'>
          ...
          <div className='flex flex-col gap-1.5'>
            ...
            <input value={name} onChange={(e) => setName(e.target.value)} placeholder='Muhammad Ayan Hashmi'
          ...
          <div className='flex flex-col gap-1.5'>
            ...
            <input type='email' value={email} onChange={(e) => setEmail(e.target.value)} placeholder='ayan@smart-ems.com'
              className='bg-zinc-950 border border-zinc-800 rounded-xl px-4 py-3 text-zinc-300 text-sm outline-none focus:border-red-600 transition-all placeholder-zinc-600'/>
          </div>
          ...
          <div className='grid grid-cols-2 gap-3'>
            <div className='flex flex-col gap-1.5'>
              ...
              <input value={designation} onChange={(e) => setDesignation(e.target.value)} placeholder='Frontend Developer'
                className='bg-zinc-950 border border-zinc-800 rounded-xl px-4 py-3 text-zinc-300 text-sm outline-none focus:border-red-600 transition-all placeholder-zinc-600'/>
            </div>
            <div className='flex flex-col gap-1.5'>
          ...
          {/* Role dropdown — sirf superadmin ke liye */}
          {currentUserRole === 'superadmin' && (
            <div className='flex flex-col gap-1.5'>
              <label className='text-zinc-500 text-xs font-semibold tracking-widest uppercase'>Role</label>
              <select
                value={role}
          ...
          <div className='flex flex-col gap-1.5'>
            <label className='text-zinc-500 text-xs font-semibold tracking-widest uppercase'>Your Password</label>
