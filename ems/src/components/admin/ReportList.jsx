import ReportData from '../../data/admin/ReportData'
  ...
  return (
    <div className='border border-zinc-800 bg-zinc-900 rounded-2xl flex flex-col max-h-[400px]'>
      ...
      <div className="flex flex-col gap-2 px-3 py-3 overflow-y-auto scrollBar">
        {ReportData.map(({ id, title, meta, borderLeft }) => (
          <div key={id} className={`bg-zinc-950 rounded-xl px-3 py-3 ${borderLeft} flex justify-between items-center`}>
